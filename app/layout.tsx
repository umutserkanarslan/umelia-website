...
const plusJakartaSans = Plus_Jakarta_Sans({ subsets: ["latin"], weight: ["700", "800"], variable: "--font-plus-jakarta" });
...
export const metadata: Metadata = {
  ...
  description: "Bodrum'daki işletmelere yapay zeka destekli otomasyon çözümleri. Otel AI asistanı, WhatsApp rezervasyon botu, QR sipariş sistemi.",
  openGraph: {
    title: "UMELIA — Automate. Optimize. Elevate.",
...
export default function RootLayout({
  ...
  return (
    <html lang="tr" className={`${inter.variable} ${plusJakartaSans.variable} ${playfair.variable} ${libreBaskerville.variable}`}>
